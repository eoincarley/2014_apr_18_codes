pro nrh_aia_imgs_all_freqs_20140418, nrh_freqs

  ;NRH and AIA composite images for 2014 April 18 event

  ;Now plot all NRH freqs on AIA image
  ...
  !p.charsize=1.5
  nrh_colors = nrh_freqs ;[3,4,6,7,8]
	...
	FOR i =0, n_elements(aia_files)-6 DO BEGIN
		...
		for k=0, n_elements(nrh_freqs)-1 do begin
			read_nrh, nrh_filenames[nrh_freqs[k]], $	; 445 MHz
					nrh_hdr, $
					nrh_data, $
					hbeg=t0;, $ 
					;hend=t1	
