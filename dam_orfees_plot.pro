...
pro dam_orfees_plot, save_orfees = save_orfees
	...
	if keyword_set(save_orfees) then begin
		...
		save, data_bg, filename = 'orf20140418_backsubbed.sav', $
			description='Data produced using sliding 5 minute background. Data is logged.'
	endif else begin
		fbands = mrdfits('orf20140418_101743.fts', 1, hdr1)
		restore, 'orf20140418_backsubbed.sav', /verb
	endelse
	...
	plot_spec, dam_spec, dam_tim, reverse(freq), [freq0, freq1], scl0=-0.1, scl1=1

	plot_spec, data_bg.STOKESI_B1, data_bg.TIME_B1, fbands.FREQ_B1, [freq0, freq1], scl0=-0.1, scl1=0.6
	plot_spec, data_bg.STOKESI_B2, data_bg.TIME_B1, fbands.FREQ_B2, [freq0, freq1], scl0=-0.1, scl1=0.6
	plot_spec, data_bg.STOKESI_B3, data_bg.TIME_B1, fbands.FREQ_B3, [freq0, freq1], scl0=-0.1, scl1=0.6
	plot_spec, data_bg.STOKESI_B4, data_bg.TIME_B1, fbands.FREQ_B4, [freq0, freq1], scl0=-3.5, scl1=0.6
	plot_spec, data_bg.STOKESI_B5, data_bg.TIME_B1, fbands.FREQ_B5, [freq0, freq1], scl0=-0.2, scl1=0.9
