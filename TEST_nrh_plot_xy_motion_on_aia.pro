...
pro TEST_nrh_plot_xy_motion_on_aia, postscript=postscript
	...
	for i=85, n_elements(xcor0[255, *])-145, 5 do $
		plots, [xcor0[255, i], xcor1[255, i]], [ycor0[255, i], ycor1[255, i]], thick=2, color=0
	...
	for j=0, n_elements(motion_files)-1 do begin
		...
		for i=0, n_elements(xarcs)-(step+1), step do begin
			...
			plots, xarcs[i], yarcs[i], color=color, psym=sym, symsize=2.0, thick=6
